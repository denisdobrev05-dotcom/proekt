...
const BG_BORDER = [
  // Северозапад и река Дунав (запад → изток)
  [22.62, 44.18], [22.78, 44.13], [22.98, 44.08], [23.10, 43.92], [23.30, 43.85],
  [23.62, 43.79], [23.92, 43.75], [24.18, 43.70], [24.45, 43.69], [24.78, 43.72],
  [25.10, 43.62], [25.38, 43.62], [25.65, 43.69], [25.95, 43.84], [26.18, 43.92],
  [26.55, 44.04], [26.85, 44.06], [27.05, 44.13], [27.26, 44.13],
  // Североизток (Добруджа) → Черно море
  [27.65, 43.95], [28.00, 43.84], [28.58, 43.69],
  // Черноморско крайбрежие (север → юг): нос Шабла, нос Калиакра,
  // Варненски и Бургаски залив, Странджанско крайбрежие
  [28.60, 43.53], [28.41, 43.43], [28.47, 43.36], [28.10, 43.38], [28.02, 43.27],
  [27.92, 43.20], [27.85, 43.05], [27.88, 42.93], [27.85, 42.80], [27.75, 42.70],
  [27.65, 42.58], [27.72, 42.43], [27.60, 42.25], [27.55, 42.10], [27.78, 42.02],
  [28.04, 41.98],
  // Южна граница с Турция (изток → запад)
  [27.55, 41.98], [27.00, 41.97], [26.62, 41.85], [26.36, 41.71],
  // Южна граница с Гърция (изток → запад, през Родопите)
  [26.15, 41.36], [25.85, 41.31], [25.55, 41.31], [25.30, 41.27], [25.10, 41.40],
  [24.85, 41.39], [24.65, 41.50], [24.50, 41.57], [24.28, 41.51], [24.05, 41.46],
  [23.75, 41.40], [23.55, 41.38], [23.40, 41.40],
  // Югозапад — Северна Македония
  [23.18, 41.38], [23.00, 41.36], [22.95, 41.52], [22.93, 41.70], [22.95, 41.85],
  [22.88, 41.99], [22.72, 42.16], [22.60, 42.30], [22.45, 42.32], [22.36, 42.32],
  // Западна граница със Сърбия (юг → север), с Транския издатък
  [22.43, 42.52], [22.50, 42.70], [22.78, 42.88], [22.62, 43.02], [22.45, 43.12],
  [22.55, 43.28], [22.58, 43.40], [22.45, 43.52], [22.38, 43.68], [22.47, 43.82],
  [22.52, 43.96]
];
...
// Превръща поредица от точки в гладка затворена крива чрез
// Catmull-Rom сплайн, преобразуван в кубични криви на Безие.
function smoothClosedPath(pts, tension = 6) {
  const n = pts.length;
